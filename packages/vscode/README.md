...
![VS Code Extension](https://github.com/skvdhshuk-blip/hao-work/raw/HEAD/packages/vscode/extension.jpg)

**Like the extension? There's also a [desktop app and web version](https://github.com/skvdhshuk-blip/hao-work) with even more features.**
...
Plus everything from the shared Hao Work UI: branchable timeline, smart tool UIs, voice mode, Git workflows, and more.

## Commands

| Command | Description |
|---------|-------------|
| `Hao Work: Focus Chat` | Focus the chat panel |
| `Hao Work: New Session` | Start a new chat session |
| `Hao Work: Open Sidebar` | Open the Hao Work sidebar |
| `Hao Work: Open Agent Manager` | Launch parallel multi-model runs |
| `Hao Work: Open Session in Editor` | Open current or new session in an editor tab |
| `Hao Work: Settings` | Open extension settings |
| `Hao Work: Restart API Connection` | Restart the OpenCode API process |
| `Hao Work: Show OpenCode Status` | Debug info for development or bug reports |

### Right-click menu

Select code in the editor, right-click, and find the **Hao Work** submenu:
