...
import { buildSessionMessageRecordsSnapshot, useDirectoryStore, useGlobalSessionStatus } from '@/sync/sync-context';
...
export const Header: React.FC<HeaderProps> = ({
  ...
  const currentSessionTitle = React.useMemo(() => {
    if (!currentSessionId) {
      return activeProjectLabel ?? 'Hao Work';
    }
      ...
      <div className="flex min-w-0 flex-1 items-center">
        {activeSurfaceHeader ? (
          <div className="mr-3 flex min-w-0 flex-col items-start px-1 py-0.5 -my-0.5 text-left">
            ...
            {(activeSurfaceHeader.subtitle || activeProjectLabel || currentBranchLabel || (!isNewSessionDraftOpen && worktreeBadgeKind)) ? (
