...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "pwa.installPrompt.description": "Instale o Hao Work para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "Hao Work instalado",
  ...
  "mobile.connect.welcome.title": "Conectar ao Hao Work",
  ...
  "mobile.connect.password.placeholder": "Senha do Hao Work",
  ...
  "mobile.connect.scan.invalid": "Esse código QR não é um código de conexão do Hao Work.",
  ...
  "mobile.connect.relay.badge": "via Hao Work Relay",
  ...
  "mobile.connect.error.unreachable": "Não foi possível acessar esse servidor Hao Work.",
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Sobre o Hao Work",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao Hao Work — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "header.services.shutdownDev": "Parar Hao Work",
  ...
  "aboutDialog.openChamberVersionLabel": "Versão do Hao Work {version}",
  "aboutDialog.openCodeVersionLabel": "Versão do HaoCode {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do Hao Work, a integridade do HaoCode, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo Hao Work com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do Hao Work",
  "header.actions.openAppMenuAria": "Abrir menu do Hao Work",
  ...
  "chat.emptyState.opencodeUnreachable": "HaoCode não está acessível",
  ...
  "chat.chatInput.permissionAutoAccept.mode.ask": "Modo de aprovação: Perguntar sempre",
  "chat.chatInput.permissionAutoAccept.mode.smart": "Modo de aprovação: Aprovação inteligente",
  "chat.chatInput.permissionAutoAccept.mode.auto": "Modo de aprovação: Tudo automático",
  "chat.chatInput.permissionAutoAccept.directory": "Aceitação automática neste diretório",
  "chat.chatInput.permissionAutoAccept.directory.description": "Ignora as solicitações de aprovação de ferramentas no diretório atual.",
  ...
  "openCodeStatusDialog.title": "Status do HaoCode",
  "openCodeStatusDialog.description": "Inspecione o status atual do HaoCode e os diagnósticos.",
  ...
  "sessionAuth.error.networkDescription": "Não foi possível verificar a sessão da interface. Se você estiver abrindo o Hao Work de outro dispositivo na sua rede local, ative o Desktop Network Access no app para desktop e use o endereço LAN mostrado em Configurações.",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear Hao Work",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do Hao Work",
  ...
  "multiRun.window.description": "Janela do Hao Work Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao Hao Work",
  ...
  "onboarding.localSetup.title": "Configuração do HaoCode",
  "onboarding.localSetup.description": "Instale a CLI do HaoCode para continuar.",
  "onboarding.localSetup.dialog.selectOpencodeBinary": "Selecionar executável de opencode",
  "onboarding.localSetup.errors.cliNotReady": "A CLI do HaoCode ainda não está pronta. Confirme que a instalação está completa e tente novamente.",
  "onboarding.localSetup.errors.detectionFailed": "Erro de detecção",
  "onboarding.localSetup.windows.title": "Configuração no Windows",
  "onboarding.localSetup.windows.stepInstallWsl": "Instale o HaoCode com o comando abaixo.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o Hao Work não detectar o HaoCode automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "HaoCode é o coração do Hao Work. Instale-o para começar.",
  "onboarding.localSetup.docs.windows": "Documentação do HaoCode",
  "onboarding.localSetup.docs.default": "Documentação do HaoCode",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Clique para verificar se a CLI do HaoCode está disponível. Se a verificação funcionar, você entrará automaticamente na tela principal.",
  "onboarding.localSetup.status.watching": "Aguardando HaoCode",
  "onboarding.localSetup.status.autoContinue": "Continuaremos automaticamente assim que detectado.",
  "onboarding.localSetup.bundledEngine.title": "Iniciando o motor integrado",
  "onboarding.localSetup.bundledEngine.description": "O Hao Work já inclui um motor HaoCode integrado — nenhuma instalação é necessária. Ele continuará automaticamente assim que estiver pronto.",
  "onboarding.localSetup.bundledEngine.status.waiting": "Iniciando o motor HaoCode integrado",
  "onboarding.localSetup.bundledEngine.status.autoContinue": "Você entrará automaticamente assim que estiver pronto.",
  "onboarding.localSetup.field.alreadyInstalled": "Já está instalado? Defina o caminho da CLI do HaoCode:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do Hao Work e recarregue configurações do HaoCode.",
  ...
  "onboarding.localSetup.windows.hintInstallInWsl": "No Windows, instale e execute o HaoCode nativamente.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do Hao Work para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor Hao Work ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instância está executando uma versão diferente do Hao Work. Você pode se conectar, mas atualize os dois apps se algo não funcionar.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "O servidor está executando Hao Work, mas não é compatível com esta versão do app. Atualize o Hao Work no servidor e tente novamente.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando Hao Work. Verifique se o endereço aponta para um servidor Hao Work.",
  ...
  "onboarding.desktopRecovery.localUnavailable.title": "HaoCode Local não disponível",
  "onboarding.desktopRecovery.localUnavailable.description": "A CLI do HaoCode não pôde ser iniciada ou não está instalada. Instale o HaoCode ou conecte um servidor remoto no lugar dela.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando Hao Work. Verifique se o endereço aponta para um servidor Hao Work.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Atualização do servidor necessária",
  "onboarding.desktopRecovery.remoteIncompatible.description": "O servidor Hao Work em \"{host}\" não é compatível com esta versão do app. Atualize o Hao Work no servidor e tente novamente.",
  ...
  "startup.initRecovery.description": "O Hao Work não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando Hao Work...",
  ...
  "mobileUpdate.toast.available.title": "Atualização do Hao Work disponível",
  ...
  "opencodeUpdate.toast.available.title": "Atualização do HaoCode",
  ...
  "opencodeUpdate.toast.actions.reload": "Recarregar HaoCode",
  "opencodeUpdate.toast.upgrading.title": "Atualizando HaoCode...",
  "opencodeUpdate.toast.upgrading.description": "Mantenha o Hao Work aberto.",
  "opencodeUpdate.toast.updated.title": "HaoCode atualizado",
  ...
  "opencodeUpdate.toast.failed.title": "Não foi possível atualizar o HaoCode",
  "opencodeUpdate.toast.failed.description": "A atualização do HaoCode falhou.",
  "opencodeUpdate.toast.reload.message": "Reiniciando HaoCode...",
  ...
  "openChamberLogo.aria.logo": "Logo do Hao Work",
  ...
  'chat.autoDecisionCard.approved': 'Aprovado automaticamente',
  'chat.autoDecisionCard.rejected': 'Rejeitado automaticamente',
  'chat.autoDecisionCard.source.rule': 'Regra',
  'chat.autoDecisionCard.source.review': 'Revisão do modelo',
  'chat.autoDecisionCard.source.sandbox': 'Ambiente isolado',
  'chat.sandboxBadge.label': 'Sandbox',
  'chat.sandboxBadge.tooltip': 'As ferramentas do agente estão sendo executadas dentro de uma máquina virtual isolada.',
  'chat.assistantError.sendFailed': 'O HaoCode falhou ao enviar a mensagem. Erro:\n`{detail}`',
  'chat.assistantError.sendFailedRetry': 'O HaoCode falhou ao enviar a mensagem. Informações da nova tentativa:\n`{detail}`',
  'chat.assistantError.stoppedBeforeSend': 'O turno em execução foi interrompido antes que o HaoCode pudesse enviar a próxima mensagem.',
  'chat.autoDecisionCard.risk': 'Risco: {level}',
  'chat.permissionEscalation.label': 'Aprovação inteligente: confirmação humana necessária',
  'chat.permissionEscalation.reason.rule_red_line': 'bloqueado por uma regra de segurança crítica',
  'chat.permissionEscalation.reason.rule_ask': 'requer revisão manual pela política',
  'chat.permissionEscalation.reason.review_unavailable': 'o modelo de revisão estava indisponível',
  'chat.permissionEscalation.reason.review_unsure': 'o modelo de revisão estava incerto',
  'chat.permissionEscalation.reason.batch_escalated': 'outra ação no mesmo lote precisa de revisão',
  'chat.permissionEscalation.reason.batch_circuit_breaker': 'aprovação automática pausada após rejeições repetidas',
  'chat.permissionEscalation.reason.unknown': 'requer uma decisão humana',
};
