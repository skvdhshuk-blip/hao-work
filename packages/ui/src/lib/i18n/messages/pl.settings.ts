export const settingsDict = {
  'settings.providers.page.openCodeGo.title': 'Śledzenie użycia HaoCode Go',
  'settings.providers.page.openCodeGo.description': 'Połącz panel HaoCode Go, aby wyświetlać limity kroczące, tygodniowe i miesięczne.',
  ...
  'settings.providers.page.openCodeGo.help': 'Skopiuj ID z adresu panelu i cookie auth z narzędzi deweloperskich przeglądarki. Hao Work nigdy nie skanuje plików cookie przeglądarki.',
  ...
  'settings.providers.page.openCodeGo.saveFailed': 'Nie udało się sprawdzić danych HaoCode Go.',
  'settings.providers.page.openCodeGo.valid': 'Dane HaoCode Go są prawidłowe.',
  'settings.providers.page.openCodeGo.invalid': 'Dane HaoCode Go są nieprawidłowe lub wygasły.',
  'settings.providers.page.openCodeGo.deleted': 'Dane HaoCode Go zostały usunięte.',
  'settings.providers.page.openCodeGo.deleteFailed': 'Nie udało się usunąć danych HaoCode Go.',
  ...
  'settings.agents.page.toast.savedManualRestart': 'Zapisano na dysku. Uruchom ponownie połączony serwer HaoCode, aby zastosować zmiany.',
  ...
  'settings.behavior.page.section.toolApproval': 'Tryb zatwierdzania',
  'settings.behavior.page.toolApproval.tooltip': 'Wybierz, jak wykonania narzędzi są zatwierdzane w każdej sesji. Inteligentne zatwierdzanie automatycznie wykonuje działania o niskim ryzyku, prosi model o sprawdzenie niepewnych i przekazuje Ci niebezpieczne.',
  'settings.behavior.page.toolApproval.groupAria': 'Tryb zatwierdzania narzędzi',
  'settings.behavior.page.toolApproval.option.ask': 'Zawsze pytaj',
  'settings.behavior.page.toolApproval.option.ask.description': 'Pytaj o zatwierdzenie przed każdym wykonaniem narzędzia.',
  'settings.behavior.page.toolApproval.option.smart': 'Inteligentne zatwierdzanie',
  'settings.behavior.page.toolApproval.option.smart.description': 'Automatycznie wykonuj działania o niskim ryzyku; pytaj, gdy są niepewne lub niebezpieczne.',
  'settings.behavior.page.toolApproval.option.auto': 'Wszystko automatycznie',
  'settings.behavior.page.toolApproval.option.auto.description': 'Automatycznie wykonuj wszystkie narzędzia; tylko pytania nadal przerywają.',
  'settings.behavior.page.toolApproval.reviewModel.label': 'Model recenzji (opcjonalny)',
  'settings.behavior.page.toolApproval.reviewModel.placeholder': 'Użyj modelu rozmowy',
  'settings.behavior.page.toolApproval.reviewModel.help': 'Używany tylko w inteligentnym zatwierdzaniu do sprawdzania niepewnych działań. Pozostaw puste, aby użyć modelu rozmowy.',
  'settings.behavior.page.toolApproval.toast.saved': 'Zapisano tryb zatwierdzania',
  'settings.behavior.page.toolApproval.toast.saveFailed': 'Nie udało się zapisać trybu zatwierdzania',
  'settings.behavior.page.toolApproval.loadError': 'Nie udało się wczytać ustawień zatwierdzania.',
  'settings.behavior.page.section.sandbox': 'Sandbox',
  'settings.behavior.page.sandbox.tooltip': 'Uruchamiaj narzędzia agenta wewnątrz maszyny wirtualnej tokimo. Piaskownica izoluje akcje na plikach, wyszukiwaniu i shellu od Twojego hosta, a inteligentne zatwierdzanie może automatycznie wykonywać działania, dla których udowodniono, że pozostają w izolacji.',
  'settings.behavior.page.sandbox.enable': 'Uruchamiaj narzędzia w sandboxie',
  'settings.behavior.page.sandbox.enableAria': 'Przełącz wykonywanie w sandboxie',
  'settings.behavior.page.sandbox.unsupported': 'Wykonywanie w sandboxie nie jest obsługiwane na tej platformie.',
  'settings.behavior.page.sandbox.prepare.action': 'Przygotuj środowisko uruchomieniowe sandboxa',
  'settings.behavior.page.sandbox.prepare.preparing': 'Przygotowywanie…',
  'settings.behavior.page.sandbox.prepare.reprepare': 'Zainstaluj ponownie środowisko',
  'settings.behavior.page.sandbox.prepare.ready': 'Środowisko gotowe',
  'settings.behavior.page.sandbox.prepare.notReady': 'Środowisko nie zostało jeszcze pobrane',
  'settings.behavior.page.sandbox.network.groupAria': 'Polityka sieciowa sandboxa',
  'settings.behavior.page.sandbox.network.blocked': 'Zablokuj sieć',
  'settings.behavior.page.sandbox.network.blocked.description': 'Brak wychodzącego dostępu do sieci z sandboxa.',
  'settings.behavior.page.sandbox.network.allowAll': 'Zezwól na sieć',
  'settings.behavior.page.sandbox.network.allowAll.description': 'Pozwól sandboxowi korzystać z sieci; wymagane do instalacji i pobierania.',
  'settings.behavior.page.sandbox.memory.label': 'Pamięć',
  'settings.behavior.page.sandbox.memory.help': 'Pomiędzy {min} MB a {max} MB.',
  'settings.behavior.page.sandbox.cpu.label': 'Procesory',
  'settings.behavior.page.sandbox.cpu.help': 'Pomiędzy {min} a {max} wirtualnymi procesorami.',
  'settings.behavior.page.sandbox.toast.saved': 'Ustawienie sandboxa zapisane',
  'settings.behavior.page.sandbox.toast.saveFailed': 'Nie udało się zapisać ustawienia sandboxa',
  'settings.behavior.page.sandbox.toast.prepared': 'Środowisko uruchomieniowe sandboxa jest gotowe',
  'settings.behavior.page.sandbox.toast.prepareFailed': 'Nie udało się przygotować środowiska uruchomieniowego sandboxa',
  'settings.behavior.page.sandbox.toast.runtimeMissing': 'Przed włączeniem przygotuj środowisko uruchomieniowe sandboxa.',
  'settings.behavior.page.sandbox.loadError': 'Nie udało się wczytać ustawień sandboxa.',
  'settings.behavior.page.toast.saved': 'Zachowanie zostało zapisane pomyślnie',
  'settings.behavior.page.warning.description': 'Zmiany wprowadzone tutaj aktualizują {path}. HaoCode uwzględnia również reguły AGENTS.md na poziomie projektu, jeśli istnieją.',
  ...
  'settings.github.page.flow.title': 'Autoryzuj Hao Work',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Dostępne jako rezerwa, jeśli uwierzytelnienie Hao Work zostanie usunięte',
  ...
  'settings.mcp.page.advanced.oauthHint': 'Pozostaw te pola puste, aby HaoCode mógł automatycznie odczytać ustawienia OAuth z serwera MCP.',
  ...
  'settings.mcp.page.advanced.timeoutHint': 'Pozostaw puste, aby użyć domyślnych ustawień HaoCode',
  ...
  'settings.mcp.page.auth.waitingForOpenCode': 'Oczekiwanie na HaoCode, aż zauważy zakończony proces autoryzacji w przeglądarce...',
  ...
  'settings.mcp.page.deleteDialog.descriptionSuffix': 'HaoCode będzie musiał zostać przeładowany.',
  ...
  'settings.mcp.page.status.description.connected': 'Połączono i gotowy do odkrywania narzędzi i zasobów przez HaoCode.',
  ...
  'settings.mcp.page.status.description.failedDefault': 'HaoCode nie mógł połączyć się z tym serwerem MCP.',
  ...
  'settings.mcp.page.toast.openCodeReloadFailedAfterCallbackSave': 'Przeładowanie HaoCode nie powiodło się po zapisaniu URL callback przeglądarki',
  ...
  'settings.mcp.page.toast.savedReloadFailed': 'Zapisano, ale przeładowanie HaoCode nie powiodło się.',
  'settings.mcp.page.toast.savedReloading': 'Zapisano. Przeładowywanie HaoCode...',
  'settings.mcp.page.toast.serverCreatedReloadFailed': 'Serwer MCP utworzony, ale przeładowanie HaoCode nie powiodło się.',
  'settings.mcp.page.toast.serverCreatedReloading': 'Serwer MCP utworzony. Przeładowywanie HaoCode...',
  'settings.mcp.page.toast.serverDeleted': '"{name}" został usunięty',
  'settings.mcp.page.toast.serverDeletedReloadFailed': '"{name}" został usunięty, ale przeładowanie HaoCode nie powiodło się',
  ...
  'settings.notifications.page.testNotification.body': 'To jest powiadomienie testowe z Hao Work.',
  ...
  'settings.openchamber.about.field.openCodeVersion': 'Wersja HaoCode',
  ...
  'settings.openchamber.about.title': 'O Hao Work',
  ...
  'settings.openchamber.defaults.summaryOpenCodeDefault': 'Domyślny agent HaoCode',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Uruchamiaj Hao Work przy logowaniu',
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Uruchamiaj Hao Work przy logowaniu',
  ...
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Minimalizuj i zamykaj Hao Work do zasobnika systemowego',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Minimalizuj i zamykaj do zasobnika systemowego',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Utrzymuje Hao Work w zasobniku systemowym Windows, gdy główne okno jest zminimalizowane lub zamknięte.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Utrzymuj komputer aktywny, gdy Hao Work jest uruchomiony',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Utrzymuj komputer aktywny, gdy Hao Work jest uruchomiony',
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'Pokazuj Hao Work na pasku menu macOS',
  'settings.openchamber.desktopNetwork.field.macMenuBar': 'Pokazuj Hao Work na pasku menu',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': 'Wymaga ponownego uruchomienia aplikacji. Po wyłączeniu Hao Work nie tworzy elementu paska menu ani nie uruchamia aktualizacji sesji, zatwierdzeń i użycia.',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'Hao Work pyta po restarcie, a potem po wygaśnięciu sesji logowania: po 12 godzinach albo po 7 dniach z opcją Zaufaj temu urządzeniu. Zostaw puste, aby wyłączyć logowanie.',
  ...
  'settings.openchamber.opencodeCli.actions.browseAria': 'Przeglądaj ścieżkę do pliku binarnego HaoCode',
  'settings.openchamber.opencodeCli.actions.restartingOpenCode': 'Restartowanie HaoCode...',
  ...
  'settings.openchamber.opencodeCli.field.binaryPath': 'Ścieżka do pliku binarnego HaoCode',
  'settings.openchamber.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.openchamber.opencodeCli.field.showUpdateNotifications': 'Pokazuj powiadomienia o aktualizacjach HaoCode',
  'settings.openchamber.opencodeCli.field.showUpdateNotificationsAria': 'Pokazuj powiadomienia o aktualizacjach HaoCode',
  ...
  'settings.openchamber.worktrees.list.tooltip': 'Worktree znajdują się poza repozytorium i są zarządzane przez HaoCode. Usunięcie worktree usuwa także powiązane sesje.',
  ...
  'settings.page.appearance.description': 'Dostosuj wygląd i odczucie Hao Work.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Klucze są wysyłane bezpośrednio do HaoCode i nigdy nie są przechowywane przez Hao Work.',
  'settings.providers.page.auth.connected': 'Połączono',
  'settings.providers.page.auth.connectedViaOAuth': 'Połączono (OAuth)',
  'settings.providers.page.auth.oauthWaitingForBrowser': 'Oczekiwanie na autoryzację w przeglądarce…',
  'settings.providers.page.auth.oauthWaitingHint': 'Dokończ logowanie w oknie przeglądarki. Ta strona zaktualizuje się automatycznie.',
  ...
  'settings.providers.page.empty.checkOpenCodeConfiguration': 'Sprawdź konfigurację HaoCode',
  ...
  'settings.providers.page.haocode.title': 'Połączenie HaoCode',
  'settings.providers.page.haocode.description': 'Zastąp bramę lub dodaj model udostępniany przez tego dostawcę.',
  'settings.providers.page.haocode.baseUrlLabel': 'Base URL',
  'settings.providers.page.haocode.providerTypeLabel': 'Typ dostawcy',
  'settings.providers.page.haocode.addModelLabel': 'Dodaj ID modelu',
  'settings.providers.page.haocode.contextWindowLabel': 'Okno kontekstu',
  'settings.providers.page.haocode.maxTokensLabel': 'Limit wyjścia',
  'settings.providers.page.haocode.inheritPlaceholder': 'Domyślne',
  'settings.providers.page.haocode.invalidNumber': 'Wpisz dodatnią liczbę całkowitą lub pozostaw puste, aby użyć wartości domyślnej.',
  'settings.providers.page.haocode.save': 'Zapisz ustawienia HaoCode',
  'settings.providers.page.haocode.toast.saved': 'Ustawienia dostawcy HaoCode zostały zapisane.',
  'settings.providers.page.haocode.toast.saveFailed': 'Nie udało się zapisać ustawień dostawcy HaoCode.',
  'settings.providers.page.haocode.imagePolicyLabel': 'Domyślne przetwarzanie obrazów',
  ...
  'settings.providers.page.models.actions.fetchRemote': 'Pobierz listę modeli',
  'settings.providers.page.models.fetch.success': 'Pobrano {count} modeli od dostawcy',
  'settings.providers.page.models.fetch.failed': 'Nie udało się pobrać listy modeli',
  'settings.providers.page.models.fetch.empty': 'Dostawca nie zwrócił żadnych modeli',
  ...
  'settings.providers.page.models.imagePolicy.ariaLabel': 'Przetwarzanie obrazów dla {model}',
  'settings.providers.page.models.imagePolicy.saveFailed': 'Nie udało się zapisać ustawienia przetwarzania obrazów.',
  'settings.providers.page.haocode.imageVlmModelLabel': 'ID modelu VLM',
  'settings.providers.page.haocode.imageVlmModelRequired': 'Podaj ID modelu do przekazania.',
  'settings.providers.page.custom.title': 'Dostawca niestandardowy',
  'settings.providers.page.custom.description': 'Utwórz definicję dostawcy opartą na własnym punkcie końcowym.',
  'settings.providers.page.custom.nameLabel': 'Nazwa',
  'settings.providers.page.custom.namePlaceholder': 'Mój dostawca',
  'settings.providers.page.custom.baseUrlLabel': 'Base URL',
  'settings.providers.page.custom.providerTypeLabel': 'Typ dostawcy',
  'settings.providers.page.custom.apiKeyLabel': 'Klucz API (opcjonalnie)',
  'settings.providers.page.custom.modelsLabel': 'ID modeli',
  'settings.providers.page.custom.modelsPlaceholder': 'model-a, model-b',
  'settings.providers.page.custom.contextWindowLabel': 'Okno kontekstu (opcjonalnie)',
  'settings.providers.page.custom.maxTokensLabel': 'Limit wyjścia (opcjonalnie)',
  'settings.providers.page.custom.create': 'Utwórz dostawcę',
  'settings.providers.page.custom.creating': 'Tworzenie...',
  'settings.providers.page.custom.toast.created': 'Dostawca niestandardowy został utworzony.',
  'settings.providers.page.custom.toast.createFailed': 'Nie udało się utworzyć dostawcy niestandardowego.',
  'settings.providers.page.custom.toast.nameConflict': 'Dostawca o tej nazwie już istnieje.',
  'settings.providers.page.custom.toast.nameRequired': 'Nazwa jest wymagana.',
  'settings.providers.page.custom.toast.baseUrlRequired': 'Adres Base URL jest wymagany.',
  'settings.providers.page.custom.toast.invalidNumber': 'Okno kontekstu i limit wyjścia muszą być dodatnimi liczbami całkowitymi lub pozostać puste.',
  'settings.providers.page.actions.deleting': 'Usuwanie...',
  'settings.providers.page.toast.customProviderDeleted': 'Dostawca niestandardowy został usunięty.',
  'settings.providers.page.toast.customProviderDeleteFailed': 'Nie udało się usunąć dostawcy niestandardowego.',
  'settings.providers.sidebar.customBadge': 'Niestandardowy',
  'settings.providers.sidebar.actions.deleteProviderAria': 'Usuń dostawcę niestandardowego',
  'settings.providers.sidebar.actions.deleteProviderTitle': 'Usuń dostawcę niestandardowego',
  'settings.providers.sidebar.dialogs.deleteProvider.title': 'Usuń dostawcę niestandardowego',
  'settings.providers.sidebar.dialogs.deleteProvider.description': 'Usunąć „{name}”? Spowoduje to usunięcie definicji dostawcy niestandardowego.',
  'settings.providers.sidebar.dialogs.deleteProvider.confirm': 'Usuń',
  'settings.providers.sidebar.dialogs.deleteProvider.cancel': 'Anuluj',
  ...
  'settings.providers.sidebar.empty.description': 'Sprawdź konfigurację HaoCode',
  ...
  'settings.remoteInstances.page.description': 'Połącz się z inną maszyną przez SSH i otwórz tam Hao Work.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'Jak Hao Work ma zostać umieszczony na zdalnej maszynie, gdy aplikacja uruchamia go za Ciebie.',
  ...
  'settings.remoteInstances.page.field.keepServerRunningHint': 'Pozostaw Hao Work uruchomiony na zdalnej maszynie po rozłączeniu.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Wybierz, czy Hao Work ma uruchomić serwer za Ciebie, czy połączyć się z już działającym.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Instalowanie Hao Work',
  ...
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Aktualizowanie Hao Work',
  ...
  'settings.remoteInstances.page.section.authenticationDescription': 'Opcjonalne dane logowania dla SSH i zdalnego interfejsu Hao Work.',
  ...
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Wybierz lokalny adres używany do otwierania tego zdalnego serwera Hao Work.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'Hao Work na zdalnej maszynie',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Wybierz, jak Hao Work ma działać po połączeniu SSH.',
  ...
  'settings.remoteInstances.direct.title': 'Inne serwery Hao Work',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Dodaj inny serwer Hao Work przez URL. Użyj tego, gdy serwer już działa i masz token połączenia.',
  ...
  'settings.remoteInstances.direct.import.description': 'Wklej link połączenia z innego serwera Hao Work.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Nieprawidłowy link połączenia Hao Work.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Utwórz bezpieczny link lub token, aby Hao Work Desktop mógł połączyć się z tym serwerem.',
  ...
  'settings.remoteInstances.clientAuth.qrAlt': 'Kod QR połączenia Hao Work',
  'settings.remoteInstances.clientAuth.qrEnlarge': 'Powiększ kod QR',
  'settings.remoteInstances.clientAuth.qrScanHint': 'Zeskanuj to aplikacją Hao Work na drugim urządzeniu. Jednorazowy i wygasa.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Działa w domu i poza nim. Poza domem ruch przechodzi przez Hao Work Private Relay — szyfrowany end-to-end tunel. Bez konfiguracji.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Zeskanuj ten kod QR aplikacją Hao Work na drugim urządzeniu.',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Dodaj repozytorium Git jako nowe źródło katalogu. Hao Work przeskanuje je w poszukiwaniu folderów zawierających',
  ...
  'settings.skills.location.option.projectOpencode.label': 'Projekt / HaoCode',
  ...
  'settings.skills.location.option.userOpencode.description': 'Globalna lokalizacja konfiguracji HaoCode',
  'settings.skills.location.option.userOpencode.label': 'Użytkownik / HaoCode',
  ...
  'settings.view.actions.reloadOpenCode': 'Przeładuj HaoCode',
  'settings.view.actions.reloadOpenCodeTooltip': 'Uruchom ponownie HaoCode i przeładuj jego konfigurację.',
  ...
  'settings.voice.page.tooltip.sttLocal': 'Transkrypcja lokalna na serwerze Hao Work. Modele pobierają się automatycznie; klucz API nie jest potrzebny.',
  'settings.voice.page.tooltip.localTts': 'Lokalna synteza na serwerze Hao Work (Kokoro, angielski). Model pobiera się automatycznie; klucz API nie jest potrzebny.',
  ...
  'settings.window.description': 'Okno ustawień Hao Work.',
