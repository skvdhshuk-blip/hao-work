...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安装 Hao Work 以便更快访问',
  'pwa.installPrompt.action': '安装',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已开始安装',
  'pwa.installPrompt.installed': 'Hao Work 已安装',
  ...
  'mobile.connect.welcome.title': '连接到 Hao Work',
  ...
  'mobile.connect.password.placeholder': 'Hao Work 密码',
  ...
  'mobile.connect.error.unreachable': '无法连接到该 Hao Work 服务器。',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '关于 Hao Work',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 Hao Work 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'filesView.editor.binaryFileDescription': '此文件为二进制文件，无法在 Hao Work 中编辑。请下载后使用其他应用打开。',
  ...
  'header.services.shutdownDev': '停止 Hao Work',
  ...
  'aboutDialog.openChamberVersionLabel': 'Hao Work 版本 {version}',
  'aboutDialog.openCodeVersionLabel': 'HaoCode 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 Hao Work 状态、HaoCode 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 Hao Work',
  ...
  'header.actions.openAppMenu': 'Hao Work 菜单',
  'header.actions.openAppMenuAria': '打开 Hao Work 菜单',
  ...
  'chat.emptyState.opencodeUnreachable': '无法连接 HaoCode',
  ...
  'chat.chatInput.permissionAutoAccept.mode.ask': '审批模式：每次都问',
  'chat.chatInput.permissionAutoAccept.mode.smart': '审批模式：智能审批',
  'chat.chatInput.permissionAutoAccept.mode.auto': '审批模式：全部自动',
  'chat.chatInput.permissionAutoAccept.directory': '在此目录中自动接受',
  'chat.chatInput.permissionAutoAccept.directory.description': '当前目录中的工具执行不再逐条询问。',
  ...
  'openCodeStatusDialog.title': 'HaoCode 状态',
  'openCodeStatusDialog.description': '查看当前 HaoCode 状态与诊断信息。',
  ...
  'sessionAuth.error.networkDescription': '无法验证 UI 会话。如果你是从本地网络中的另一台设备打开 Hao Work，请在桌面端应用中启用 Desktop Network Access，并使用设置中显示的 LAN 地址。',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 Hao Work',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 Hao Work 服务器之间切换',
  ...
  'multiRun.window.description': 'Hao Work 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 Hao Work',
  ...
  'onboarding.localSetup.title': '设置 HaoCode',
  'onboarding.localSetup.description': '安装 HaoCode CLI 以继续。',
  'onboarding.localSetup.dialog.selectOpencodeBinary': '选择 HaoCode 可执行文件',
  'onboarding.localSetup.errors.cliNotReady': 'HaoCode CLI 尚未就绪。请确认安装完成后重试。',
  'onboarding.localSetup.errors.detectionFailed': '检测失败',
  'onboarding.localSetup.windows.title': 'Windows 设置',
  'onboarding.localSetup.windows.stepInstallWsl': '使用下方命令安装 HaoCode。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Hao Work 未自动检测到 HaoCode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'HaoCode 是 Hao Work 的核心，先安装它即可开始。',
  'onboarding.localSetup.docs.windows': 'HaoCode 文档',
  'onboarding.localSetup.docs.default': 'HaoCode 文档',
  ...
  'onboarding.localSetup.helper.checkAndContinue': '点击检测 HaoCode CLI 是否可用。成功后将自动进入主界面。',
  'onboarding.localSetup.status.watching': '正在等待 HaoCode',
  'onboarding.localSetup.status.autoContinue': '检测到后将自动继续。',
  'onboarding.localSetup.bundledEngine.title': '正在启动内置引擎',
  'onboarding.localSetup.bundledEngine.description': 'Hao Work 已内置 HaoCode 引擎，无需安装任何组件。引擎就绪后将自动继续。',
  'onboarding.localSetup.bundledEngine.status.waiting': '正在启动内置 HaoCode 引擎',
  'onboarding.localSetup.bundledEngine.status.autoContinue': '引擎就绪后将自动进入。',
  'onboarding.localSetup.field.alreadyInstalled': '已安装？设置 HaoCode CLI 路径：',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 Hao Work 设置并重新加载 HaoCode 配置。',
  'onboarding.localSetup.remotePreference': '更希望使用远程服务器？',
  'onboarding.localSetup.actions.connectRemoteServer': '连接远程服务器 →',
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，请原生安装并运行 HaoCode。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 Hao Work 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 Hao Work 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 Hao Work。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 Hao Work，但与此应用版本不兼容。请更新服务器上的 Hao Work 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 Hao Work。请确认地址是否指向 Hao Work 服务器。',
  'onboarding.remoteConnection.probe.unreachableMessage': '服务器不可达。请检查网络连接并确认服务器地址。',
  'onboarding.desktopRecovery.localUnavailable.title': '本地 HaoCode 不可用',
  'onboarding.desktopRecovery.localUnavailable.description': 'HaoCode CLI 无法启动或未安装。请安装 HaoCode，或改为连接远程服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 Hao Work。请确认地址是否指向 Hao Work 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 Hao Work 服务器与此应用版本不兼容。请更新服务器上的 Hao Work 后重试。',
  ...
  'startup.initRecovery.description': 'Hao Work 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'updateDialog.header.updating': '正在更新 Hao Work...',
  ...
  'mobileUpdate.toast.available.title': 'Hao Work 更新可用',
  ...
  'opencodeUpdate.toast.available.title': 'HaoCode 更新',
  ...
  'opencodeUpdate.toast.actions.reload': '重载 HaoCode',
  'opencodeUpdate.toast.upgrading.title': '正在更新 HaoCode...',
  'opencodeUpdate.toast.upgrading.description': '请保持 Hao Work 打开。',
  'opencodeUpdate.toast.updated.title': 'HaoCode 已更新',
  'opencodeUpdate.toast.updated.description': '更新已安装。',
  'opencodeUpdate.toast.updated.descriptionWithVersion': '版本 {version} 已安装。',
  'opencodeUpdate.toast.failed.title': '无法更新 HaoCode',
  'opencodeUpdate.toast.failed.description': 'HaoCode 升级失败。',
  'opencodeUpdate.toast.reload.message': '正在重启 HaoCode...',
  ...
  'openChamberLogo.aria.logo': 'Hao Work 标志',
  ...
  'chat.autoDecisionCard.approved': '已自动放行',
  'chat.autoDecisionCard.rejected': '已自动拒绝',
  'chat.autoDecisionCard.source.rule': '规则',
  'chat.autoDecisionCard.source.review': '模型复核',
  'chat.autoDecisionCard.source.sandbox': '沙箱',
  'chat.sandboxBadge.label': 'Sandbox',
  'chat.sandboxBadge.tooltip': '智能体工具正在沙箱虚拟机中运行。',
  'chat.assistantError.sendFailed': 'HaoCode 发送消息失败，错误：\n`{detail}`',
  'chat.assistantError.sendFailedRetry': 'HaoCode 发送消息失败。重试信息：\n`{detail}`',
  'chat.assistantError.stoppedBeforeSend': '当前运行在 HaoCode 发送下一条消息前被停止。',
  'chat.autoDecisionCard.risk': '风险：{level}',
  'chat.permissionEscalation.label': '智能审批：需人工确认',
  'chat.permissionEscalation.reason.rule_red_line': '命中安全红线规则',
  'chat.permissionEscalation.reason.rule_ask': '按策略需人工复核',
  'chat.permissionEscalation.reason.review_unavailable': '评审模型不可用',
  'chat.permissionEscalation.reason.review_unsure': '评审模型无法确定',
  'chat.permissionEscalation.reason.batch_escalated': '同批次其他操作需人工复核',
  'chat.permissionEscalation.reason.batch_circuit_breaker': '连续拒绝后已暂停自动审批',
  'chat.permissionEscalation.reason.unknown': '需要人工决定',
};
