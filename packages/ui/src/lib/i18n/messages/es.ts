...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instala Hao Work para acceder más rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Descartar",
  "pwa.installPrompt.started": "Instalación iniciada",
  "pwa.installPrompt.installed": "Hao Work se instaló",
  ...
  "mobile.connect.welcome.title": "Conéctate a Hao Work",
  ...
  "mobile.connect.password.placeholder": "Contraseña de Hao Work",
  ...
  "mobile.connect.scan.invalid": "Ese código QR no es un código de conexión de Hao Work.",
  ...
  "mobile.connect.relay.badge": "a través de Hao Work Relay",
  ...
  "mobile.connect.error.unreachable": "No se pudo conectar con ese servidor de Hao Work.",
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Acerca de Hao Work",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a Hao Work: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "filesView.editor.binaryFileDescription": "Este archivo es binario y no se puede editar en Hao Work. Descárgalo para abrirlo con otra aplicación.",
  ...
  "header.services.shutdownDev": "Detener Hao Work",
  ...
  "aboutDialog.openChamberVersionLabel": "Versión de Hao Work {version}",
  "aboutDialog.openCodeVersionLabel": "Versión de HaoCode {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de Hao Work, el estado de HaoCode, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por Hao Work de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de Hao Work",
  "header.actions.openAppMenuAria": "Abrir menú de Hao Work",
  ...
  "chat.emptyState.opencodeUnreachable": "HaoCode no es accesible",
  ...
  "chat.chatInput.permissionAutoAccept.mode.ask": "Modo de aprobación: Preguntar siempre",
  "chat.chatInput.permissionAutoAccept.mode.smart": "Modo de aprobación: Aprobación inteligente",
  "chat.chatInput.permissionAutoAccept.mode.auto": "Modo de aprobación: Todo automático",
  "chat.chatInput.permissionAutoAccept.directory": "Aceptación automática en este directorio",
  "chat.chatInput.permissionAutoAccept.directory.description": "Omite las solicitudes de aprobación de herramientas en el directorio actual.",
  ...
  "openCodeStatusDialog.title": "Estado de HaoCode",
  "openCodeStatusDialog.description": "Inspecciona el estado actual de HaoCode y diagnósticos.",
  ...
  "sessionAuth.error.networkDescription": "No pudimos verificar la sesión de la UI. Si abres Hao Work desde otro dispositivo en tu red local, activa Desktop Network Access en la app de escritorio y usa la dirección LAN que aparece en Ajustes.",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de Hao Work",
  ...
  "multiRun.window.description": "Ventana de Hao Work Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a Hao Work",
  ...
  "onboarding.localSetup.title": "Configuración de HaoCode",
  "onboarding.localSetup.description": "Instala la CLI de HaoCode para continuar.",
  "onboarding.localSetup.dialog.selectOpencodeBinary": "Seleccionar ejecutable de opencode",
  "onboarding.localSetup.errors.cliNotReady": "La CLI de HaoCode aún no está lista. Confirma que la instalación está completa y intenta de nuevo.",
  ...
  "onboarding.localSetup.windows.stepInstallWsl": "Instala HaoCode con el comando siguiente.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si Hao Work no detecta HaoCode automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "HaoCode es el corazón de Hao Work. Instálalo para empezar.",
  "onboarding.localSetup.docs.windows": "Documentación de HaoCode",
  "onboarding.localSetup.docs.default": "Documentación de HaoCode",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Haz clic para verificar si la CLI de HaoCode está disponible. Si la verificación funciona, entrarás automáticamente en la pantalla principal.",
  "onboarding.localSetup.status.watching": "Esperando HaoCode",
  "onboarding.localSetup.status.autoContinue": "Continuaremos automáticamente al detectarlo.",
  "onboarding.localSetup.bundledEngine.title": "Iniciando el motor integrado",
  "onboarding.localSetup.bundledEngine.description": "Hao Work incluye un motor HaoCode integrado: no necesitas instalar nada. Continuará automáticamente en cuanto esté listo.",
  "onboarding.localSetup.bundledEngine.status.waiting": "Iniciando el motor HaoCode integrado",
  "onboarding.localSetup.bundledEngine.status.autoContinue": "Entrarás automáticamente en cuanto esté listo.",
  "onboarding.localSetup.field.alreadyInstalled": "¿Ya está instalado? Establece la ruta de la CLI de HaoCode:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de Hao Work y recarga la configuración de HaoCode.",
  ...
  "onboarding.localSetup.windows.hintInstallInWsl": "En Windows, instala y ejecuta HaoCode de forma nativa.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de Hao Work para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor Hao Work o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instancia ejecuta una versión diferente de Hao Work. Puedes conectarte, pero actualiza ambas apps si algo no funciona.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "El servidor ejecuta Hao Work pero no es compatible con esta versión de la app. Actualiza Hao Work en el servidor y vuelve a intentarlo.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando Hao Work. Verifica que la dirección apunte a un servidor Hao Work.",
  ...
  "onboarding.desktopRecovery.localUnavailable.title": "HaoCode Local no disponible",
  "onboarding.desktopRecovery.localUnavailable.description": "La CLI de HaoCode no pudo iniciarse o no está instalado. Instala HaoCode o conecta a un servidor remoto en su lugar.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando Hao Work. Verifica que la dirección apunte a un servidor Hao Work.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Actualización del servidor requerida",
  "onboarding.desktopRecovery.remoteIncompatible.description": "El servidor Hao Work en \"{host}\" no es compatible con esta versión de la app. Actualiza Hao Work en el servidor y vuelve a intentarlo.",
  ...
  "startup.initRecovery.description": "Hao Work no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando Hao Work...",
  ...
  "mobileUpdate.toast.available.title": "Actualización de Hao Work disponible",
  ...
  "opencodeUpdate.toast.available.title": "Actualización de HaoCode",
  ...
  "opencodeUpdate.toast.actions.reload": "Recargar HaoCode",
  "opencodeUpdate.toast.upgrading.title": "Actualizando HaoCode...",
  "opencodeUpdate.toast.upgrading.description": "Mantén Hao Work abierto.",
  "opencodeUpdate.toast.updated.title": "HaoCode actualizado",
  ...
  "opencodeUpdate.toast.failed.title": "No se pudo actualizar HaoCode",
  "opencodeUpdate.toast.failed.description": "La actualización de HaoCode falló.",
  ...
  "openChamberLogo.aria.logo": "Logo de Hao Work",
  ...
  'chat.autoDecisionCard.approved': 'Aprobado automáticamente',
  'chat.autoDecisionCard.rejected': 'Rechazado automáticamente',
  ...
  'chat.autoDecisionCard.risk': 'Riesgo: {level}',
  'chat.permissionEscalation.label': 'Aprobación inteligente: se requiere confirmación humana',
  'chat.permissionEscalation.reason.rule_red_line': 'bloqueado por una regla de seguridad crítica',
  'chat.permissionEscalation.reason.rule_ask': 'requiere revisión manual según la política',
  'chat.permissionEscalation.reason.review_unavailable': 'el modelo de revisión no estaba disponible',
  'chat.permissionEscalation.reason.review_unsure': 'el modelo de revisión no estaba seguro',
  'chat.permissionEscalation.reason.batch_escalated': 'otra acción del mismo lote requiere revisión',
  'chat.permissionEscalation.reason.batch_circuit_breaker': 'aprobación automática en pausa tras rechazos repetidos',
  'chat.permissionEscalation.reason.unknown': 'requiere una decisión humana',
};
