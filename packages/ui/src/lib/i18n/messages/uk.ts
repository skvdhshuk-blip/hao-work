...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Установіть Hao Work для швидшого доступу",
  "pwa.installPrompt.action": "Установити",
  "pwa.installPrompt.dismiss": "Сховати",
  "pwa.installPrompt.started": "Установлення розпочато",
  "pwa.installPrompt.installed": "Hao Work встановлено",
  ...
  "mobile.connect.welcome.title": "Підключись до Hao Work",
  ...
  "mobile.connect.password.placeholder": "Пароль Hao Work",
  ...
  "mobile.connect.scan.invalid": "Це не QR-код підключення Hao Work.",
  ...
  "mobile.connect.relay.badge": "через Hao Work Relay",
  ...
  "mobile.connect.error.unreachable": "Не вдалося достукатись до цього Hao Work сервера.",
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Про Hao Work",
  ...
  "contextPanel.browser.trustNotice": "Сторінки, відкриті тут, працюють із повним доступом до Hao Work — це потрібно для inspect і скріншотів. Відкривайте лише сайти, яким довіряєте: шкідлива сторінка може прочитати ваші дані чи діяти від вашого імені.",
  ...
  "filesView.editor.binaryFileDescription": "Цей файл є бінарним і його не можна редагувати в Hao Work. Завантажте його, щоб відкрити в іншій програмі.",
  ...
  "header.services.shutdownDev": "Зупинити Hao Work",
  ...
  "aboutDialog.openChamberVersionLabel": "Версія Hao Work {version}",
  "aboutDialog.openCodeVersionLabel": "Версія HaoCode {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Містить стан Hao Work, стан HaoCode, каталоги та проєкти.",
  ...
  "helpDialog.description": "Використовуйте ці комбінації клавіш для ефективної навігації Hao Work",
  ...
  "header.actions.openAppMenu": "Меню Hao Work",
  "header.actions.openAppMenuAria": "Відкрити меню Hao Work",
  ...
  "chat.emptyState.opencodeUnreachable": "HaoCode недоступний",
  ...
  "chat.chatInput.permissionAutoAccept.mode.ask": "Режим схвалення: Завжди питати",
  "chat.chatInput.permissionAutoAccept.mode.smart": "Режим схвалення: Розумне схвалення",
  "chat.chatInput.permissionAutoAccept.mode.auto": "Режим схвалення: Все автоматично",
  "chat.chatInput.permissionAutoAccept.directory": "Автоматично приймати в цьому каталозі",
  "chat.chatInput.permissionAutoAccept.directory.description": "Пропускати запити на схвалення інструментів у поточному каталозі.",
  ...
  "openCodeStatusDialog.title": "Статус HaoCode",
  "openCodeStatusDialog.description": "Перегляньте поточний стан HaoCode і діагностику.",
  ...
  "sessionAuth.error.networkDescription": "Нам не вдалося перевірити сесію інтерфейсу. Якщо ви відкриваєте Hao Work з іншого пристрою у локальній мережі, увімкніть Desktop Network Access у настільному застосунку та використайте LAN-адресу, показану в налаштуваннях.",
  ...
  "sessionAuth.locked.unlockTitle": "Розблокувати Hao Work",
  ...
  "desktopHostSwitcher.description": "Перемикання між Local і віддаленими Hao Work серверами",
  ...
  "multiRun.window.description": "Вікно мультизапуску Hao Work.",
  ...
  "onboarding.chooser.title": "Ласкаво просимо до Hao Work",
  ...
  "onboarding.localSetup.title": "Налаштування HaoCode",
  "onboarding.localSetup.description": "Установіть HaoCode CLI, щоб продовжити.",
  "onboarding.localSetup.dialog.selectOpencodeBinary": "Вибрати виконуваний файл opencode",
  "onboarding.localSetup.errors.cliNotReady": "HaoCode CLI ще не готовий. Підтвердьте, що встановлення завершено, і повторіть спробу.",
  "onboarding.localSetup.errors.detectionFailed": "Не вдалося виявити",
  "onboarding.localSetup.windows.title": "Налаштування Windows",
  "onboarding.localSetup.windows.stepInstallWsl": "Встановіть HaoCode за допомогою наведеної нижче команди.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Якщо Hao Work не визначає HaoCode автоматично, укажіть шлях до виконуваного файла нижче.",
  "onboarding.localSetup.intro": "HaoCode — серце Hao Work. Встановіть його, щоб почати.",
  "onboarding.localSetup.docs.windows": "Документація HaoCode",
  "onboarding.localSetup.docs.default": "Документація HaoCode",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Натисніть, щоб перевірити, чи доступний HaoCode CLI. У разі успіху ви автоматично перейдете на головний екран.",
  "onboarding.localSetup.status.watching": "Очікування HaoCode",
  "onboarding.localSetup.status.autoContinue": "Ми автоматично продовжимо після виявлення.",
  "onboarding.localSetup.bundledEngine.title": "Запуск вбудованого рушія",
  "onboarding.localSetup.bundledEngine.description": "Hao Work містить вбудований рушій HaoCode — нічого встановлювати не потрібно. Він продовжить автоматично, щойно буде готовий.",
  "onboarding.localSetup.bundledEngine.status.waiting": "Запуск вбудованого рушія HaoCode",
  "onboarding.localSetup.bundledEngine.status.autoContinue": "Ви перейдете автоматично, щойно він буде готовий.",
  "onboarding.localSetup.field.alreadyInstalled": "Вже встановлено? Встановіть шлях HaoCode CLI:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Зберігає налаштування в Hao Work і перезавантажує конфігурацію HaoCode.",
  ...
  "onboarding.localSetup.windows.hintInstallInWsl": "У Windows інсталюйте та запускайте HaoCode нативно.",
  ...
  "onboarding.remoteConnection.description": "Введіть адресу сервера Hao Work для підключення.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Пропозиції: переконайтеся, що URL вказує на сервер Hao Work або зверніться до адміністратора сервера.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Цей інстанс працює з іншою версією Hao Work. Можна підключитися, але оновіть обидва застосунки, якщо щось не працюватиме.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "Сервер працює з Hao Work, але несумісний із цією версією застосунку. Оновіть Hao Work на сервері та повторіть спробу.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "Сервер відповів, але не працює Hao Work. Перевірте, чи адреса вказує на сервер Hao Work.",
  ...
  "onboarding.desktopRecovery.localUnavailable.title": "HaoCode Local недоступний",
  "onboarding.desktopRecovery.localUnavailable.description": "HaoCode CLI не вдалося запустити або не встановлено. Встановіть HaoCode або підключіться до віддаленого сервера.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "На сервері \"{host}\" не запущено Hao Work. Перевірте, чи адреса вказує на сервер Hao Work.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Потрібне оновлення сервера",
  "onboarding.desktopRecovery.remoteIncompatible.description": "Сервер Hao Work на \"{host}\" несумісний із цією версією застосунку. Оновіть Hao Work на сервері та повторіть спробу.",
  ...
  "startup.initRecovery.description": "Hao Work не зміг завершити ініціалізацію. Перевірте, що сервер запущений, і повторіть спробу.",
  ...
  "updateDialog.header.updating": "Оновлення Hao Work...",
  ...
  "mobileUpdate.toast.available.title": "Доступне оновлення Hao Work",
  ...
  "opencodeUpdate.toast.available.title": "Оновлення HaoCode",
  ...
  "opencodeUpdate.toast.actions.reload": "Перезавантажити HaoCode",
  "opencodeUpdate.toast.upgrading.title": "Оновлення HaoCode...",
  "opencodeUpdate.toast.upgrading.description": "Залиште Hao Work відкритим.",
  "opencodeUpdate.toast.updated.title": "HaoCode оновлено",
  ...
  "opencodeUpdate.toast.failed.title": "Не вдалося оновити HaoCode",
  "opencodeUpdate.toast.failed.description": "Оновлення HaoCode не вдалося.",
  "opencodeUpdate.toast.reload.message": "Перезапуск HaoCode...",
  ...
  "openChamberLogo.aria.logo": "Логотип Hao Work",
  ...
  'chat.autoDecisionCard.approved': 'Автоматично схвалено',
  'chat.autoDecisionCard.rejected': 'Автоматично відхилено',
  ...
  'chat.autoDecisionCard.risk': 'Ризик: {level}',
  'chat.permissionEscalation.label': 'Розумне схвалення: потрібне підтвердження людиною',
  'chat.permissionEscalation.reason.rule_red_line': 'заблоковано правилом безпеки (червона лінія)',
  'chat.permissionEscalation.reason.rule_ask': 'потребує ручної перевірки згідно з політикою',
  'chat.permissionEscalation.reason.review_unavailable': 'модель перевірки була недоступна',
  'chat.permissionEscalation.reason.review_unsure': 'модель перевірки не була впевнена',
  'chat.permissionEscalation.reason.batch_escalated': 'інша дія в тому ж пакеті потребує перевірки',
  'chat.permissionEscalation.reason.batch_circuit_breaker': 'автоматичне схвалення призупинено після повторних відхилень',
  'chat.permissionEscalation.reason.unknown': 'потрібне рішення людини',
};
