...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 Hao Work를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.dismiss': '닫기',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'Hao Work가 설치되었습니다',
  ...
  'mobile.connect.welcome.title': 'Hao Work에 연결',
  ...
  'mobile.connect.password.placeholder': 'Hao Work 비밀번호',
  ...
  'mobile.connect.scan.invalid': '이 QR 코드는 Hao Work 연결 코드가 아닙니다.',
  ...
  'mobile.connect.relay.badge': 'Hao Work Relay 경유',
  ...
  'mobile.connect.error.unreachable': '해당 Hao Work 서버에 연결할 수 없습니다.',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'Hao Work 정보',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 Hao Work에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'header.services.shutdownDev': 'Hao Work 종료',
  ...
  'aboutDialog.openChamberVersionLabel': 'Hao Work 버전 {version}',
  'aboutDialog.openCodeVersionLabel': 'HaoCode 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Hao Work 상태, HaoCode 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'helpDialog.description': '이 단축키로 Hao Work를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'Hao Work 메뉴',
  'header.actions.openAppMenuAria': 'Hao Work 메뉴 열기',
  ...
  'chat.emptyState.opencodeUnreachable': 'HaoCode에 연결할 수 없음',
  ...
  'chat.chatInput.permissionAutoAccept.mode.ask': '승인 모드: 매번 묻기',
  'chat.chatInput.permissionAutoAccept.mode.smart': '승인 모드: 스마트 승인',
  'chat.chatInput.permissionAutoAccept.mode.auto': '승인 모드: 전체 자동',
  'chat.chatInput.permissionAutoAccept.directory': '이 디렉터리에서 자동 승인',
  'chat.chatInput.permissionAutoAccept.directory.description': '현재 디렉터리의 도구 실행 승인 요청을 건너뜁니다.',
  ...
  'openCodeStatusDialog.title': 'HaoCode 상태',
  'openCodeStatusDialog.description': '현재 HaoCode 상태와 진단 정보를 확인합니다.',
  ...
  'sessionAuth.error.networkDescription': 'UI 세션을 확인할 수 없습니다. 로컬 네트워크의 다른 기기에서 Hao Work를 열고 있다면 데스크톱 앱에서 Desktop Network Access를 활성화하고 설정에 표시되는 LAN 주소를 사용하세요.',
  ...
  'sessionAuth.locked.unlockTitle': 'Hao Work 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 Hao Work 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'Hao Work 멀티런 창.',
  ...
  'onboarding.chooser.title': 'Hao Work에 오신 것을 환영합니다',
  ...
  'onboarding.localSetup.title': 'HaoCode 설정',
  'onboarding.localSetup.description': '계속하려면 HaoCode CLI를 설치하세요.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'opencode 바이너리 선택',
  'onboarding.localSetup.errors.cliNotReady': 'HaoCode CLI가 아직 준비되지 않았습니다. 설치가 완료되었는지 확인하고 다시 시도하세요.',
  'onboarding.localSetup.errors.detectionFailed': '감지에 실패했습니다',
  'onboarding.localSetup.windows.title': 'Windows 설정',
  'onboarding.localSetup.windows.stepInstallWsl': '아래 명령으로 HaoCode를 설치하세요.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Hao Work가 HaoCode를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'HaoCode는 Hao Work의 심장입니다. 먼저 설치하고 시작하세요.',
  'onboarding.localSetup.docs.windows': 'HaoCode 문서',
  'onboarding.localSetup.docs.default': 'HaoCode 문서',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'HaoCode CLI를 사용할 수 있으면 확인을 누르세요. 성공하면 자동으로 메인 화면으로 이동합니다.',
  'onboarding.localSetup.status.watching': 'HaoCode 대기 중',
  'onboarding.localSetup.status.autoContinue': '감지되면 자동으로 계속됩니다.',
  'onboarding.localSetup.bundledEngine.title': '내장 엔진을 시작하는 중입니다',
  'onboarding.localSetup.bundledEngine.description': 'Hao Work에는 HaoCode 엔진이 내장되어 있어 별도로 설치할 필요가 없습니다. 준비가 완료되면 자동으로 계속 진행합니다.',
  'onboarding.localSetup.bundledEngine.status.waiting': '내장 HaoCode 엔진을 시작하는 중입니다',
  'onboarding.localSetup.bundledEngine.status.autoContinue': '준비가 완료되면 자동으로 진입합니다.',
  'onboarding.localSetup.field.alreadyInstalled': '이미 설치되어 있나요? HaoCode CLI 경로 설정:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Hao Work 설정에 저장하고 HaoCode 구성을 다시 로드합니다.',
  'onboarding.localSetup.remotePreference': '원격 서버를 사용하시겠어요?',
  'onboarding.localSetup.actions.connectRemoteServer': '리모트 서버 연결 →',
  'onboarding.localSetup.windows.hintInstallInWsl': 'Windows에서는 HaoCode를 네이티브로 설치하고 실행하세요.',
  ...
  'onboarding.remoteConnection.description': '연결할 Hao Work 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 Hao Work 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '이 인스턴스는 다른 Hao Work 버전을 실행 중입니다. 연결할 수 있지만 문제가 있으면 양쪽 앱을 업데이트하세요.',
  'onboarding.remoteConnection.probe.incompatibleMessage': '서버에서 Hao Work가 실행 중이지만 이 앱 버전과 호환되지 않습니다. 서버의 Hao Work를 업데이트한 후 다시 시도하세요.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 Hao Work가 실행 중이 아닙니다. 주소가 Hao Work 서버를 가리키는지 확인하세요.',
  'onboarding.remoteConnection.probe.unreachableMessage': '서버에 연결할 수 없습니다. 네트워크 연결과 서버 주소를 확인하세요.',
  'onboarding.desktopRecovery.localUnavailable.title': '로컬 HaoCode를 사용할 수 없음',
  'onboarding.desktopRecovery.localUnavailable.description': 'HaoCode CLI를 시작할 수 없거나 설치되어 있지 않습니다. HaoCode를 설치하거나 원격 서버에 연결하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 Hao Work가 실행 중이 아닙니다. 주소가 Hao Work 서버를 가리키는지 확인하세요.',
  'onboarding.desktopRecovery.remoteIncompatible.title': '서버 업데이트 필요',
  'onboarding.desktopRecovery.remoteIncompatible.description': '"{host}"의 Hao Work 서버가 이 앱 버전과 호환되지 않습니다. 서버의 Hao Work를 업데이트한 후 다시 시도하세요.',
  ...
  'startup.initRecovery.description': 'Hao Work 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'Hao Work 업데이트 중…',
  ...
  'mobileUpdate.toast.available.title': 'Hao Work 업데이트 사용 가능',
  ...
  'opencodeUpdate.toast.available.title': 'HaoCode 업데이트',
  ...
  'opencodeUpdate.toast.actions.reload': 'HaoCode 다시 로드',
  'opencodeUpdate.toast.upgrading.title': 'HaoCode 업데이트 중...',
  'opencodeUpdate.toast.upgrading.description': 'Hao Work를 열어 두세요.',
  'opencodeUpdate.toast.updated.title': 'HaoCode 업데이트 완료',
  ...
  'opencodeUpdate.toast.failed.title': 'HaoCode를 업데이트할 수 없음',
  'opencodeUpdate.toast.failed.description': 'HaoCode 업그레이드에 실패했습니다.',
  'opencodeUpdate.toast.reload.message': 'HaoCode 다시 시작 중...',
  ...
  'openChamberLogo.aria.logo': 'Hao Work 로고',
  ...
  'chat.autoDecisionCard.approved': '자동 승인됨',
  'chat.autoDecisionCard.rejected': '자동 거부됨',
  'chat.autoDecisionCard.source.rule': '규칙',
  'chat.autoDecisionCard.source.review': '모델 검토',
  'chat.autoDecisionCard.source.sandbox': '샌드박스',
  'chat.sandboxBadge.label': '샌드박스',
  'chat.sandboxBadge.tooltip': '에이전트 도구가 샌드박스 가상 머신 안에서 실행되고 있습니다.',
  'chat.assistantError.sendFailed': 'HaoCode가 메시지 전송에 실패했습니다. 오류:\n`{detail}`',
  'chat.assistantError.sendFailedRetry': 'HaoCode가 메시지 전송에 실패했습니다. 재시도 정보:\n`{detail}`',
  'chat.assistantError.stoppedBeforeSend': 'HaoCode가 다음 메시지를 보내기 전에 실행 중인 턴이 중지되었습니다.',
  'chat.autoDecisionCard.risk': '위험: {level}',
  'chat.permissionEscalation.label': '스마트 승인: 사람 확인 필요',
  'chat.permissionEscalation.reason.rule_red_line': '보안 레드라인 규칙에 해당합니다',
  'chat.permissionEscalation.reason.rule_ask': '정책상 수동 검토가 필요합니다',
  'chat.permissionEscalation.reason.review_unavailable': '검토 모델을 사용할 수 없습니다',
  'chat.permissionEscalation.reason.review_unsure': '검토 모델이 확신하지 못했습니다',
  'chat.permissionEscalation.reason.batch_escalated': '같은 배치의 다른 작업에 검토가 필요합니다',
  'chat.permissionEscalation.reason.batch_circuit_breaker': '연속 거부로 자동 승인이 일시 중지되었습니다',
  'chat.permissionEscalation.reason.unknown': '사람의 결정이 필요합니다',
};
