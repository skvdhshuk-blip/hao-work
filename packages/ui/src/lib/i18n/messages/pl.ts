...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj Hao Work, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'Hao Work został zainstalowany',
  ...
  'mobile.connect.welcome.title': 'Połącz z Hao Work',
  ...
  'mobile.connect.password.placeholder': 'Hasło Hao Work',
  ...
  'mobile.connect.scan.invalid': 'Ten kod QR nie jest kodem połączenia Hao Work.',
  ...
  'mobile.connect.relay.badge': 'przez Hao Work Relay',
  ...
  'mobile.connect.error.unreachable': 'Nie udało się połączyć z tym serwerem Hao Work.',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'O Hao Work',
  ...
  'chat.emptyState.opencodeUnreachable': 'HaoCode jest nieosiągalny',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia Hao Work.',
  ...
  'onboarding.chooser.title': 'Witaj w Hao Work',
  ...
  'onboarding.localSetup.title': 'Konfiguracja HaoCode',
  'onboarding.localSetup.description': 'Zainstaluj CLI HaoCode aby kontynuować.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'Wybierz binarkę opencode',
  'onboarding.localSetup.errors.cliNotReady': 'HaoCode CLI nie jest jeszcze gotowy. Potwierdź, że instalacja jest kompletna i spróbuj ponownie.',
  ...
  'onboarding.localSetup.windows.stepInstallWsl': 'Zainstaluj HaoCode za pomocą poniższego polecenia.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli Hao Work nie wykryje HaoCode automatycznie, ustaw ścieżkę binarki poniżej.',
  'onboarding.localSetup.docs.windows': 'Dokumentacja HaoCode',
  'onboarding.localSetup.docs.default': 'Wyświetl dokumentację',
  'onboarding.localSetup.actions.checking': 'Sprawdzanie...',
  'onboarding.localSetup.helper.checkAndContinue': 'Kliknij aby sprawdzić czy HaoCode CLI jest dostępny. Jeśli się uda, automatycznie przejdziesz do głównego ekranu.',
  'onboarding.localSetup.field.alreadyInstalled': 'Juz zainstalowane? Ustaw ścieżkę binarki HaoCode:',
  'onboarding.localSetup.actions.browse': 'Przeglądaj',
  'onboarding.localSetup.actions.apply': 'Zastosuj',
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień Hao Work i przeładowuje konfigurację HaoCode.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'W Windows zainstaluj i uruchom HaoCode natywnie.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera Hao Work aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer Hao Work, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji Hao Work. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia Hao Work, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj Hao Work na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim Hao Work. Zweryfikuj czy adres wskazuje na serwer Hao Work.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'HaoCode lokalny niedostępny',
  'onboarding.desktopRecovery.localUnavailable.description': 'Nie można było uruchomić HaoCode CLI lub nie jest zainstalowany. Zainstaluj HaoCode lub połącz się z serwerem zdalnym.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia Hao Work. Zweryfikuj czy adres wskazuje na serwer Hao Work.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer Hao Work pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj Hao Work na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'Hao Work nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan Hao Work, kondycję HaoCode, katalogi i projekty.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Wersja Hao Work {version}',
  'aboutDialog.openCodeVersionLabel': 'Wersja HaoCode {version}',
  ...
  'chat.chatInput.permissionAutoAccept.mode.ask': 'Tryb zatwierdzania: Zawsze pytaj',
  'chat.chatInput.permissionAutoAccept.mode.smart': 'Tryb zatwierdzania: Inteligentne zatwierdzanie',
  'chat.chatInput.permissionAutoAccept.mode.auto': 'Tryb zatwierdzania: Wszystko automatycznie',
  'chat.chatInput.permissionAutoAccept.directory': 'Automatyczna akceptacja w tym katalogu',
  'chat.chatInput.permissionAutoAccept.directory.description': 'Pomija prośby o zatwierdzenie narzędzi w bieżącym katalogu.',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do Hao Work — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami Hao Work',
  ...
  'header.actions.openAppMenu': 'Menu Hao Work',
  'header.actions.openAppMenuAria': 'Otwórz menu Hao Work',
  ...
  'header.services.shutdownDev': 'Zatrzymaj Hao Work',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po Hao Work.',
  ...
  'openCodeStatusDialog.description': 'Sprawdź bieżący status i diagnostykę HaoCode.',
  'openCodeStatusDialog.empty.noData': 'Brak danych.',
  'openCodeStatusDialog.title': 'Status HaoCode',
  ...
  'sessionAuth.error.networkDescription': 'Nie udało się zweryfikować sesji UI. Jeśli otwierasz Hao Work z innego urządzenia w sieci lokalnej, włącz Desktop Network Access w aplikacji desktopowej i użyj adresu LAN widocznego w Ustawieniach.',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj Hao Work',
  ...
  'mobileUpdate.toast.available.title': 'Dostępna aktualizacja Hao Work',
  ...
  'updateDialog.header.updating': 'Aktualizowanie Hao Work...',
  ...
  'opencodeUpdate.toast.available.title': 'Aktualizacja HaoCode',
  ...
  'opencodeUpdate.toast.actions.reload': 'Przeładuj HaoCode',
  'opencodeUpdate.toast.upgrading.title': 'Aktualizowanie HaoCode...',
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw Hao Work otwarte.',
  'opencodeUpdate.toast.updated.title': 'HaoCode zaktualizowany',
  ...
  'opencodeUpdate.toast.failed.title': 'Nie udało się zaktualizować HaoCode',
  'opencodeUpdate.toast.failed.description': 'Aktualizacja HaoCode nie powiodła się.',
  'opencodeUpdate.toast.reload.message': 'Ponowne uruchamianie HaoCode...',
  ...
  'onboarding.localSetup.intro': 'HaoCode to serce Hao Work — zainstaluj je, aby zacząć.',
  'onboarding.localSetup.actions.checkNow': 'Sprawdź teraz',
  'onboarding.localSetup.status.watching': 'Czekanie na HaoCode',
  'onboarding.localSetup.status.autoContinue': 'Przejdziemy dalej automatycznie, gdy zostanie wykryty.',
  'onboarding.localSetup.bundledEngine.title': 'Uruchamianie wbudowanego silnika',
  'onboarding.localSetup.bundledEngine.description': 'Hao Work ma wbudowany silnik HaoCode — nie trzeba niczego instalować. Działanie będzie kontynuowane automatycznie, gdy tylko będzie gotowy.',
  'onboarding.localSetup.bundledEngine.status.waiting': 'Uruchamianie wbudowanego silnika HaoCode',
  'onboarding.localSetup.bundledEngine.status.autoContinue': 'Wejście nastąpi automatycznie, gdy tylko będzie gotowy.',
  ...
  'chat.autoDecisionCard.approved': 'Zatwierdzono automatycznie',
  'chat.autoDecisionCard.rejected': 'Odrzucono automatycznie',
  ...
  'chat.autoDecisionCard.risk': 'Ryzyko: {level}',
  'chat.permissionEscalation.label': 'Inteligentne zatwierdzanie: wymagane potwierdzenie przez człowieka',
  'chat.permissionEscalation.reason.rule_red_line': 'zablokowane przez regułę bezpieczeństwa (czerwona linia)',
  'chat.permissionEscalation.reason.rule_ask': 'wymaga ręcznej weryfikacji zgodnie z polityką',
  'chat.permissionEscalation.reason.review_unavailable': 'model recenzji był niedostępny',
  'chat.permissionEscalation.reason.review_unsure': 'model recenzji nie był pewien',
  'chat.permissionEscalation.reason.batch_escalated': 'inna akcja w tej samej partii wymaga weryfikacji',
  'chat.permissionEscalation.reason.batch_circuit_breaker': 'automatyczne zatwierdzanie wstrzymane po powtarzających się odrzuceniach',
  'chat.permissionEscalation.reason.unknown': 'wymaga decyzji człowieka',
} as const;
