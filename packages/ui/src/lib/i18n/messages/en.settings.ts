export const settingsDict = {
  'settings.providers.page.openCodeGo.title': 'HaoCode Go usage tracking',
  'settings.providers.page.openCodeGo.description': 'Connect the HaoCode Go dashboard to show rolling, weekly, and monthly quota.',
  'settings.providers.page.openCodeGo.workspaceId': 'Workspace ID',
  'settings.providers.page.openCodeGo.authCookie': 'Auth cookie',
  'settings.providers.page.openCodeGo.help': 'Copy the workspace ID from the dashboard URL and the auth cookie from your browser developer tools. Hao Work never scans browser cookie storage.',
  ...
  'settings.providers.page.openCodeGo.saveFailed': 'Could not validate HaoCode Go credentials.',
  'settings.providers.page.openCodeGo.valid': 'HaoCode Go credentials are valid.',
  'settings.providers.page.openCodeGo.invalid': 'HaoCode Go credentials are invalid or expired.',
  'settings.providers.page.openCodeGo.deleted': 'HaoCode Go credentials deleted.',
  'settings.providers.page.openCodeGo.deleteFailed': 'Could not delete HaoCode Go credentials.',
  ...
  'settings.window.description': 'Hao Work settings window.',
  ...
  'settings.view.actions.reloadOpenCode': 'Reload HaoCode',
  'settings.view.actions.reloadOpenCodeTooltip': 'Restart HaoCode and reload its configuration.',
  ...
  'settings.page.appearance.description': 'Customize how Hao Work looks and feels.',
  ...
  'settings.remoteInstances.direct.title': 'Other Hao Work servers',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Add another Hao Work server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another Hao Work server.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid Hao Work connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so Hao Work Desktop can connect to this server.',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': 'Scan this with the Hao Work app on your other device. It is single-use and expires.',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Works at home and away. Away traffic goes through Hao Work Private Relay — an end-to-end encrypted tunnel. No setup needed.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Scan this QR code with the Hao Work app on your other device.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether Hao Work should start the server for you, or connect to one that is already running.',
  ...
  'settings.openchamber.about.title': 'About Hao Work',
  'settings.openchamber.about.field.version': 'Version',
  'settings.openchamber.about.field.openCodeVersion': 'HaoCode version',
  ...
  'settings.agents.page.toast.savedManualRestart': 'Saved to disk. Restart your connected HaoCode server to apply the changes.',
  ...
  'settings.behavior.page.warning.description': 'Changes made here update {path}. HaoCode also includes any project-level AGENTS.md rules when they exist.',
  ...
  'settings.behavior.page.section.toolApproval': 'Approval mode',
  'settings.behavior.page.toolApproval.tooltip': 'Choose how tool executions are approved in every session. Smart approval auto-runs low-risk actions, asks a model to review uncertain ones, and hands dangerous ones to you.',
  'settings.behavior.page.toolApproval.groupAria': 'Tool approval mode',
  'settings.behavior.page.toolApproval.option.ask': 'Ask every time',
  'settings.behavior.page.toolApproval.option.ask.description': 'Ask for approval before every tool execution.',
  'settings.behavior.page.toolApproval.option.smart': 'Smart approval',
  'settings.behavior.page.toolApproval.option.smart.description': 'Auto-run low-risk actions; ask when uncertain or dangerous.',
  'settings.behavior.page.toolApproval.option.auto': 'Full auto',
  'settings.behavior.page.toolApproval.option.auto.description': 'Auto-run all tools; only question prompts still ask.',
  'settings.behavior.page.toolApproval.reviewModel.label': 'Review model (optional)',
  'settings.behavior.page.toolApproval.reviewModel.placeholder': 'Reuse the conversation model',
  'settings.behavior.page.toolApproval.reviewModel.help': 'Only used in Smart approval to review uncertain actions. Leave empty to reuse the conversation model.',
  'settings.behavior.page.toolApproval.toast.saved': 'Approval mode saved',
  'settings.behavior.page.toolApproval.toast.saveFailed': 'Failed to save approval mode',
  'settings.behavior.page.toolApproval.loadError': 'Approval settings could not be loaded.',
  'settings.behavior.page.section.sandbox': 'Sandbox',
  'settings.behavior.page.sandbox.tooltip': 'Run agent tools inside a tokimo virtual machine. The sandbox isolates file, search, and shell actions from your host, and smart approval can auto-run actions proven to stay contained.',
  'settings.behavior.page.sandbox.enable': 'Run tools in sandbox',
  'settings.behavior.page.sandbox.enableAria': 'Toggle sandbox execution',
  'settings.behavior.page.sandbox.unsupported': 'Sandbox execution is not supported on this platform.',
  'settings.behavior.page.sandbox.prepare.action': 'Prepare sandbox runtime',
  'settings.behavior.page.sandbox.prepare.preparing': 'Preparing…',
  'settings.behavior.page.sandbox.prepare.reprepare': 'Reinstall runtime',
  'settings.behavior.page.sandbox.prepare.ready': 'Runtime ready',
  'settings.behavior.page.sandbox.prepare.notReady': 'Runtime not downloaded yet',
  'settings.behavior.page.sandbox.network.groupAria': 'Sandbox network policy',
  'settings.behavior.page.sandbox.network.blocked': 'Block network',
  'settings.behavior.page.sandbox.network.blocked.description': 'No outbound network access from the sandbox.',
  'settings.behavior.page.sandbox.network.allowAll': 'Allow network',
  'settings.behavior.page.sandbox.network.allowAll.description': 'Let the sandbox reach the network; required for installs and fetches.',
  'settings.behavior.page.sandbox.memory.label': 'Memory',
  'settings.behavior.page.sandbox.memory.help': 'Between {min} MB and {max} MB.',
  'settings.behavior.page.sandbox.cpu.label': 'CPUs',
  'settings.behavior.page.sandbox.cpu.help': 'Between {min} and {max} virtual CPUs.',
  'settings.behavior.page.sandbox.toast.saved': 'Sandbox setting saved',
  'settings.behavior.page.sandbox.toast.saveFailed': 'Failed to save sandbox setting',
  'settings.behavior.page.sandbox.toast.prepared': 'Sandbox runtime is ready',
  'settings.behavior.page.sandbox.toast.prepareFailed': 'Failed to prepare sandbox runtime',
  'settings.behavior.page.sandbox.toast.runtimeMissing': 'Prepare the sandbox runtime before enabling it.',
  'settings.behavior.page.sandbox.loadError': 'Sandbox settings could not be loaded.',
  ...
  'settings.skills.location.option.userOpencode.label': 'User / HaoCode',
  'settings.skills.location.option.userOpencode.description': 'Global HaoCode config location',
  'settings.skills.location.option.projectOpencode.label': 'Project / HaoCode',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. Hao Work will scan it for folders containing',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Start Hao Work at login',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Start Hao Work when you log in',
  ...
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Minimize and close Hao Work to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Minimize and close to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Keeps Hao Work running in the Windows system tray when the main window is minimized or closed.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while Hao Work is running',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Keep computer awake while Hao Work is running',
  ...
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'Show Hao Work in the macOS menu bar',
  'settings.openchamber.desktopNetwork.field.macMenuBar': 'Show Hao Work in the menu bar',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': 'Requires an app restart. When off, Hao Work does not create the menu bar item or run its session, approval, and usage updates.',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'Hao Work asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  ...
  'settings.openchamber.opencodeCli.field.binaryPath': 'HaoCode Binary Path',
  'settings.openchamber.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.openchamber.opencodeCli.field.showUpdateNotifications': 'Show HaoCode update notifications',
  'settings.openchamber.opencodeCli.field.showUpdateNotificationsAria': 'Show HaoCode update notifications',
  'settings.openchamber.opencodeCli.actions.browseAria': 'Browse for HaoCode binary path',
  ...
  'settings.openchamber.opencodeCli.actions.restartingOpenCode': 'Restarting HaoCode…',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open Hao Work there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'Hao Work on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how Hao Work should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Local access',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Choose the local address used to open this remote Hao Work server.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote Hao Work UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How Hao Work should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Installing Hao Work',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Updating Hao Work',
  ...
  'settings.openchamber.worktrees.list.tooltip': 'Worktrees live outside the repo (HaoCode-managed). Deleting a worktree also removes linked sessions.',
  ...
  'settings.providers.sidebar.empty.description': 'Check your HaoCode configuration',
  ...
  'settings.providers.page.empty.checkOpenCodeConfiguration': 'Check your HaoCode configuration',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to HaoCode and never stored by Hao Work.',
  ...
  'settings.providers.page.auth.connectedViaOAuth': 'Connected (OAuth)',
  'settings.providers.page.auth.oauthWaitingForBrowser': 'Waiting for browser authorization…',
  'settings.providers.page.auth.oauthWaitingHint': 'Finish signing in in the browser window. This page will update automatically.',
  ...
  'settings.providers.page.haocode.title': 'HaoCode connection',
  'settings.providers.page.haocode.description': 'Override the gateway or add a model exposed by this provider.',
  'settings.providers.page.haocode.baseUrlLabel': 'Base URL',
  'settings.providers.page.haocode.providerTypeLabel': 'Provider type',
  'settings.providers.page.haocode.addModelLabel': 'Add model ID',
  'settings.providers.page.haocode.contextWindowLabel': 'Context window',
  'settings.providers.page.haocode.maxTokensLabel': 'Output limit',
  'settings.providers.page.haocode.inheritPlaceholder': 'Default',
  'settings.providers.page.haocode.invalidNumber': 'Enter a positive integer, or leave empty to use the default.',
  'settings.providers.page.haocode.save': 'Save HaoCode settings',
  'settings.providers.page.haocode.toast.saved': 'HaoCode provider settings saved.',
  'settings.providers.page.haocode.toast.saveFailed': 'Failed to save HaoCode provider settings.',
  'settings.providers.page.haocode.imagePolicyLabel': 'Default image handling',
  ...
  'settings.providers.page.models.actions.fetchRemote': 'Fetch model list',
  'settings.providers.page.models.fetch.success': 'Fetched {count} models from the provider',
  'settings.providers.page.models.fetch.failed': 'Failed to fetch the model list',
  'settings.providers.page.models.fetch.empty': 'The provider returned no models',
  ...
  'settings.providers.page.models.imagePolicy.ariaLabel': 'Image handling for {model}',
  'settings.providers.page.models.imagePolicy.saveFailed': 'Failed to save the image handling setting.',
  'settings.providers.page.haocode.imageVlmModelLabel': 'VLM model ID',
  'settings.providers.page.haocode.imageVlmModelRequired': 'Enter a model ID for the VLM pass-through.',
  'settings.providers.page.custom.title': 'Custom provider',
  'settings.providers.page.custom.description': 'Create a provider definition backed by your own endpoint.',
  'settings.providers.page.custom.nameLabel': 'Name',
  'settings.providers.page.custom.namePlaceholder': 'My provider',
  'settings.providers.page.custom.baseUrlLabel': 'Base URL',
  'settings.providers.page.custom.providerTypeLabel': 'Provider type',
  'settings.providers.page.custom.apiKeyLabel': 'API key (optional)',
  'settings.providers.page.custom.modelsLabel': 'Model IDs',
  'settings.providers.page.custom.modelsPlaceholder': 'model-a, model-b',
  'settings.providers.page.custom.contextWindowLabel': 'Context window (optional)',
  'settings.providers.page.custom.maxTokensLabel': 'Output limit (optional)',
  'settings.providers.page.custom.create': 'Create provider',
  'settings.providers.page.custom.creating': 'Creating...',
  'settings.providers.page.custom.toast.created': 'Custom provider created.',
  'settings.providers.page.custom.toast.createFailed': 'Failed to create custom provider.',
  'settings.providers.page.custom.toast.nameConflict': 'A provider with this name already exists.',
  'settings.providers.page.custom.toast.nameRequired': 'Name is required.',
  'settings.providers.page.custom.toast.baseUrlRequired': 'Base URL is required.',
  'settings.providers.page.custom.toast.invalidNumber': 'Context window and output limit must be positive integers, or left empty.',
  'settings.providers.page.actions.deleting': 'Deleting...',
  'settings.providers.page.toast.customProviderDeleted': 'Custom provider deleted.',
  'settings.providers.page.toast.customProviderDeleteFailed': 'Failed to delete custom provider.',
  'settings.providers.sidebar.customBadge': 'Custom',
  'settings.providers.sidebar.actions.deleteProviderAria': 'Delete custom provider',
  'settings.providers.sidebar.actions.deleteProviderTitle': 'Delete custom provider',
  'settings.providers.sidebar.dialogs.deleteProvider.title': 'Delete custom provider',
  'settings.providers.sidebar.dialogs.deleteProvider.description': 'Delete "{name}"? This removes the custom provider definition.',
  'settings.providers.sidebar.dialogs.deleteProvider.confirm': 'Delete',
  'settings.providers.sidebar.dialogs.deleteProvider.cancel': 'Cancel',
  ...
  'settings.mcp.page.status.description.connected': 'Connected and ready for HaoCode to discover tools and resources.',
  'settings.mcp.page.status.description.failedDefault': 'HaoCode could not reach this MCP server.',
  ...
  'settings.mcp.page.auth.waitingForOpenCode': 'Waiting for HaoCode to observe the completed browser authorization flow...',
  ...
  'settings.mcp.page.advanced.timeoutHint': 'Leave blank to use HaoCode\'s default MCP timeout.',
  ...
  'settings.mcp.page.advanced.oauthHint': 'Leave these fields blank to let HaoCode infer OAuth settings from the MCP server.',
  ...
  'settings.mcp.page.deleteDialog.descriptionSuffix': 'HaoCode will need to reload.',
  ...
  'settings.mcp.page.toast.serverCreatedReloadFailed': 'MCP server created, but HaoCode reload failed.',
  'settings.mcp.page.toast.savedReloadFailed': 'Saved, but HaoCode reload failed.',
  'settings.mcp.page.toast.retryRefreshHint': 'Retry refresh or reopen Settings before authorizing this server.',
  'settings.mcp.page.toast.serverCreatedReloading': 'MCP server created. HaoCode reloading…',
  'settings.mcp.page.toast.savedReloading': 'Saved. HaoCode reloading…',
  'settings.mcp.page.toast.saveFailed': 'Failed to save',
  'settings.mcp.page.toast.unexpectedError': 'An error occurred',
  'settings.mcp.page.toast.serverDeletedReloadFailed': '"{name}" deleted, but HaoCode reload failed',
  ...
  'settings.mcp.page.toast.openCodeReloadFailedAfterCallbackSave': 'HaoCode reload failed after saving the browser callback URL',
  ...
  'settings.openchamber.defaults.summaryOpenCodeDefault': 'HaoCode agent default',
  ...
  'settings.github.page.flow.title': 'Authorize Hao Work',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if Hao Work auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from Hao Work.',
  ...
  'settings.voice.page.tooltip.sttLocal': 'On-device transcription on the Hao Work server. Models download automatically; no API key needed.',
  'settings.voice.page.tooltip.localTts': 'On-device synthesis on the Hao Work server (Kokoro, English). The model downloads automatically; no API key needed.',
