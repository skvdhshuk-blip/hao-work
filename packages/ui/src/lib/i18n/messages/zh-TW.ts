...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安裝 Hao Work 以便更快存取',
  'pwa.installPrompt.action': '安裝',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已開始安裝',
  'pwa.installPrompt.installed': 'Hao Work 已安裝',
  ...
  'mobile.connect.welcome.title': '連線至 Hao Work',
  ...
  'mobile.connect.password.placeholder': 'Hao Work 密碼',
  ...
  'mobile.connect.scan.invalid': '此 QR code 不是 Hao Work 連線代碼。',
  ...
  'mobile.connect.relay.badge': '透過 Hao Work Relay 連線',
  ...
  'mobile.connect.error.unreachable': '無法連線至該 Hao Work 伺服器。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 Hao Work。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 Hao Work，但與此應用程式版本不相容。請更新伺服器上的 Hao Work 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 Hao Work 伺服器與此應用程式版本不相容。請更新伺服器上的 Hao Work 後重試。',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '關於 Hao Work',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 Hao Work 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'aboutDialog.diagnosticsDescription': '包含 Hao Work 狀態、HaoCode 健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 Hao Work',
  ...
  'header.actions.openAppMenu': 'Hao Work 選單',
  'header.actions.openAppMenuAria': '開啟 Hao Work 選單',
  ...
  'chat.emptyState.opencodeUnreachable': '無法連線 HaoCode',
  ...
  'chat.chatInput.permissionAutoAccept.mode.ask': '審批模式：每次都問',
  'chat.chatInput.permissionAutoAccept.mode.smart': '審批模式：智能審批',
  'chat.chatInput.permissionAutoAccept.mode.auto': '審批模式：全部自動',
  'chat.chatInput.permissionAutoAccept.directory': '在此目錄中自動接受',
  'chat.chatInput.permissionAutoAccept.directory.description': '目前目錄中的工具執行不再逐條詢問。',
  ...
  'openCodeStatusDialog.title': 'HaoCode 狀態',
  'openCodeStatusDialog.description': '查看目前 HaoCode 狀態與診斷資訊。',
  ...
  'sessionAuth.error.networkDescription': '無法驗證 UI 會話。如果你是從本機網路中的其他裝置開啟 Hao Work，請在桌面應用程式中啟用 Desktop Network Access，並使用設定中顯示的 LAN 位址。',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 Hao Work',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 Hao Work 伺服器之間切換',
  ...
  'multiRun.window.description': 'Hao Work 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 Hao Work',
  ...
  'onboarding.localSetup.title': '設定 HaoCode',
  'onboarding.localSetup.description': '安裝 HaoCode CLI 以繼續。',
  'onboarding.localSetup.dialog.selectOpencodeBinary': '選擇 HaoCode 執行檔',
  'onboarding.localSetup.errors.cliNotReady': 'HaoCode CLI 尚未就緒。請確認安裝完成後重試。',
  'onboarding.localSetup.errors.detectionFailed': '偵測失敗',
  'onboarding.localSetup.windows.title': 'Windows 設定',
  'onboarding.localSetup.windows.stepInstallWsl': '使用下方命令安裝 HaoCode。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Hao Work 未自動偵測到 HaoCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'HaoCode 是 Hao Work 的核心，先安裝它即可開始。',
  'onboarding.localSetup.docs.windows': 'HaoCode 文件',
  'onboarding.localSetup.docs.default': 'HaoCode 文件',
  ...
  'onboarding.localSetup.helper.checkAndContinue': '點擊偵測 HaoCode CLI 是否可用。成功後將自動進入主介面。',
  'onboarding.localSetup.status.watching': '正在等待 HaoCode',
  'onboarding.localSetup.status.autoContinue': '偵測到後將自動繼續。',
  'onboarding.localSetup.bundledEngine.title': '正在啟動內建引擎',
  'onboarding.localSetup.bundledEngine.description': 'Hao Work 已內建 HaoCode 引擎，無需安裝任何元件。引擎就緒後將自動繼續。',
  'onboarding.localSetup.bundledEngine.status.waiting': '正在啟動內建 HaoCode 引擎',
  'onboarding.localSetup.bundledEngine.status.autoContinue': '引擎就緒後將自動進入。',
  'onboarding.localSetup.field.alreadyInstalled': '已安裝？設定 HaoCode CLI 路徑：',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 Hao Work 設定並重新載入 HaoCode 設定。',
  'onboarding.localSetup.remotePreference': '更希望使用遠端伺服器？',
  'onboarding.localSetup.actions.connectRemoteServer': '連接遠端伺服器 →',
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，請原生安裝並執行 HaoCode。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 Hao Work 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 Hao Work 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 Hao Work。請確認位址是否指向 Hao Work 伺服器。',
  'onboarding.remoteConnection.probe.unreachableMessage': '伺服器無法連線。請檢查網路連線並確認伺服器位址。',
  'onboarding.desktopRecovery.localUnavailable.title': '本地 HaoCode 無法使用',
  'onboarding.desktopRecovery.localUnavailable.description': 'HaoCode CLI 無法啟動或未安裝。請安裝 HaoCode，或改為連接遠端伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 Hao Work。請確認位址是否指向 Hao Work 伺服器。',
  ...
  'startup.initRecovery.description': 'Hao Work 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'opencodeUpdate.toast.actions.reload': '重新載入 HaoCode',
  'opencodeUpdate.toast.upgrading.title': '正在更新 HaoCode...',
  'opencodeUpdate.toast.upgrading.description': '請保持 Hao Work 開啟。',
  ...
  'opencodeUpdate.toast.failed.title': '無法更新 HaoCode',
  'opencodeUpdate.toast.failed.description': 'HaoCode 升級失敗。',
  'opencodeUpdate.toast.reload.message': '正在重新啟動 HaoCode...',
  ...
  'openChamberLogo.aria.logo': 'Hao Work 標誌',
  ...
  'chat.autoDecisionCard.approved': '已自動放行',
  'chat.autoDecisionCard.rejected': '已自動拒絕',
  ...
  'chat.autoDecisionCard.risk': '風險：{level}',
  'chat.permissionEscalation.label': '智能審批：需人工確認',
  'chat.permissionEscalation.reason.rule_red_line': '命中安全紅線規則',
  'chat.permissionEscalation.reason.rule_ask': '依策略需人工複核',
  'chat.permissionEscalation.reason.review_unavailable': '評審模型不可用',
  'chat.permissionEscalation.reason.review_unsure': '評審模型無法確定',
  'chat.permissionEscalation.reason.batch_escalated': '同批次其他操作需人工複核',
  'chat.permissionEscalation.reason.batch_circuit_breaker': '連續拒絕後已暫停自動審批',
  'chat.permissionEscalation.reason.unknown': '需要人工決定',
};
