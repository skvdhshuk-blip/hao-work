...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install Hao Work for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'Hao Work installed',
  ...
  'mobile.connect.welcome.title': 'Connect to Hao Work',
  ...
  'mobile.connect.password.placeholder': 'Hao Work password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not an Hao Work connection code.',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that Hao Work server.',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'About Hao Work',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to Hao Work — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'filesView.editor.binaryFileDescription': 'This file is binary and cannot be edited in Hao Work. Download it to open with another app.',
  ...
  'header.services.shutdownDev': 'Stop Hao Work',
  ...
  'aboutDialog.openChamberVersionLabel': 'Hao Work version {version}',
  'aboutDialog.openCodeVersionLabel': 'HaoCode version {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes Hao Work state, HaoCode health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate Hao Work efficiently',
  ...
  'header.actions.openAppMenu': 'Hao Work menu',
  'header.actions.openAppMenuAria': 'Open Hao Work menu',
  ...
  'chat.emptyState.opencodeUnreachable': 'HaoCode is not reachable',
  ...
  'chat.chatInput.permissionAutoAccept.mode.ask': 'Approval mode: Ask every time',
  'chat.chatInput.permissionAutoAccept.mode.smart': 'Approval mode: Smart approval',
  'chat.chatInput.permissionAutoAccept.mode.auto': 'Approval mode: Full auto',
  'chat.chatInput.permissionAutoAccept.directory': 'Auto-accept in this directory',
  'chat.chatInput.permissionAutoAccept.directory.description': 'Skip approval prompts for tools in the current directory.',
  ...
  'openCodeStatusDialog.title': 'HaoCode Status',
  'openCodeStatusDialog.description': 'Inspect current HaoCode status and diagnostics.',
  ...
  'sessionAuth.error.networkDescription': 'We could not verify the UI session. If you\'re opening Hao Work from another device on your local network, make sure Desktop Network Access is enabled on the desktop app and use the LAN address shown in Settings.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock Hao Work',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote Hao Work servers',
  ...
  'multiRun.window.description': 'Hao Work Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to Hao Work',
  ...
  'onboarding.localSetup.title': 'Setting Up HaoCode',
  'onboarding.localSetup.description': 'Install HaoCode CLI to continue.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'Select opencode binary',
  'onboarding.localSetup.errors.cliNotReady': 'HaoCode CLI is not ready yet. Please confirm installation is complete and try again.',
  'onboarding.localSetup.errors.detectionFailed': 'Detection failed',
  'onboarding.localSetup.windows.title': 'Windows setup',
  'onboarding.localSetup.windows.stepInstallWsl': 'Install HaoCode with the command below.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If Hao Work does not detect HaoCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'HaoCode is the heart of Hao Work — install it to get started.',
  'onboarding.localSetup.docs.windows': 'HaoCode docs',
  'onboarding.localSetup.docs.default': 'HaoCode docs',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'Click to check if HaoCode CLI is available. If successful, you\'ll automatically enter the main screen.',
  'onboarding.localSetup.status.watching': 'Waiting for HaoCode',
  'onboarding.localSetup.status.autoContinue': "We'll continue automatically once it's detected.",
  'onboarding.localSetup.bundledEngine.title': 'Starting the built-in engine',
  'onboarding.localSetup.bundledEngine.description': 'Hao Work ships with a built-in HaoCode engine — no installation needed. It will continue automatically as soon as it is ready.',
  'onboarding.localSetup.bundledEngine.status.waiting': 'Starting the built-in HaoCode engine',
  'onboarding.localSetup.bundledEngine.status.autoContinue': "You'll enter automatically once it's ready.",
  'onboarding.localSetup.field.alreadyInstalled': 'Already installed? Set the HaoCode CLI path:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to Hao Work settings and reloads HaoCode configuration.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'On Windows, install and run HaoCode natively.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an Hao Work server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an Hao Work server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different Hao Work version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running Hao Work but is not compatible with this app version. Update Hao Work on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running Hao Work. Verify the address points to an Hao Work server.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'Local HaoCode Unavailable',
  'onboarding.desktopRecovery.localUnavailable.description': 'HaoCode CLI could not be started or is not installed. Install HaoCode or connect to a remote server instead.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running Hao Work. Verify the address points to an Hao Work server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The Hao Work server at "{host}" is not compatible with this app version. Update Hao Work on the server, then try again.',
  ...
  'startup.initRecovery.description': 'Hao Work could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating Hao Work...',
  ...
  'mobileUpdate.toast.available.title': 'Hao Work update available',
  ...
  'opencodeUpdate.toast.available.title': 'HaoCode update',
  ...
  'opencodeUpdate.toast.actions.reload': 'Reload HaoCode',
  'opencodeUpdate.toast.upgrading.title': 'Updating HaoCode...',
  'opencodeUpdate.toast.upgrading.description': 'Keep Hao Work open.',
  'opencodeUpdate.toast.updated.title': 'HaoCode updated',
  ...
  'opencodeUpdate.toast.failed.title': 'Could not update HaoCode',
  'opencodeUpdate.toast.failed.description': 'The HaoCode upgrade failed.',
  'opencodeUpdate.toast.reload.message': 'Restarting HaoCode...',
  ...
  'openChamberLogo.aria.logo': 'Hao Work logo',
  ...
  'chat.autoDecisionCard.approved': 'Auto-approved',
  'chat.autoDecisionCard.rejected': 'Auto-rejected',
  ...
  'chat.autoDecisionCard.risk': 'Risk: {level}',
  'chat.permissionEscalation.label': 'Smart approval: manual review required',
  'chat.permissionEscalation.reason.rule_red_line': 'blocked by a security red-line rule',
  'chat.permissionEscalation.reason.rule_ask': 'requires manual review by policy',
  'chat.permissionEscalation.reason.review_unavailable': 'the review model was unavailable',
  'chat.permissionEscalation.reason.review_unsure': 'the review model was unsure',
  'chat.permissionEscalation.reason.batch_escalated': 'another action in the same batch needs review',
  'chat.permissionEscalation.reason.batch_circuit_breaker': 'auto-approval paused after repeated rejections',
  'chat.permissionEscalation.reason.unknown': 'needs a human decision',
} as const;
