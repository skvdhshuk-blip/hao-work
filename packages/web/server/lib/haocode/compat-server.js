...
const PROVIDER_DEFINITIONS = {
  ...
  // China-region and coding-focused presets appended after the original set.
  // kimi-coding speaks the Anthropic protocol; the rest are OpenAI-compatible.
  'kimi-coding': {
  ...
  siliconflow: {
    ...
    models: ['Pro/MiniMaxAI/MiniMax-M2.7', 'deepseek-ai/DeepSeek-V3.2'],
  },
  stepfun: {
    name: '阶跃星辰',
    providerType: 'openai_chat',
